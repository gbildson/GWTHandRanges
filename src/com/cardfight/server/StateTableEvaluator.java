...
public class StateTableEvaluator {
  ...
  private static int    size             = 612978;					// lookup table size
	...
	private static String HAND_RANKS_FILE;
	static {
	    if ( !(TEMP_DIR.endsWith("/") || TEMP_DIR.endsWith("\\")) )
		   TEMP_DIR = TEMP_DIR + System.getProperty("file.separator");
		HAND_RANKS_FILE = TEMP_DIR + "handRanks.ser";
	}
